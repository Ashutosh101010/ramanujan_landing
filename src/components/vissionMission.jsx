      ...
      <div className="row" style={{ padding: '15rem 0 15rem 0', background: "#93351A", color: "#fff" }}>
        ...
        <div className="col-xs-12 col-md-8 col-lg-7">
          <p style={{ fontSize: "20px" }} id="vissionmission-paragraph">
            The vision and mission of both directors are to work on the theme of Super-30. They are committed to work hard  consistently and fulfilling the dream of Super-30 Indore. They are highly experienced in their field (subjects) and have spent most of their time in leadership roles in the biggest coaching centers for IIT-JEE/NEET in India, particularly in Kota.
          </p>
        </div>
      </div>
      <div className="row" style={{ padding: '14rem 0 14rem 0' }}>
        ...
        <div className="col-xs-12 col-md-7">
          <ul style={{ listStyle: "inside", fontSize: "20px" }} id="vissionmission-paragraph">
            <li style={{ margin: '15px' }}>Personal Attention to Students in the Batch of 30 Students.</li>
            ...
            <li style={{ margin: '15px' }}>Maximum Number of tests compared to any other coaching.</li>
            <li style={{ margin: '15px' }}>Rapid test (Time Management).</li>
            <li style={{ margin: '15px' }}>Time to Time parents interaction.</li>
